...
\begin{itemize}
	\item Literal - that consist of two or three elements %%http://www.w3.org/TR/rdf11-concepts/#section-Graph-Literal
		...
		\subitem Language tag - specified only when the the datatype IRI is \emph{'http://www.w3.org/1999/02/22-rdf-syntax-ns\#langString'}
	\item IRI
	\item blank node
\end{itemize}
