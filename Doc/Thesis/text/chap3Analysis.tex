...
\todoi{maybe add in introduction section about existing database solutions (graph db, document db, nosql vs sql)- where the term document database is introduced}
