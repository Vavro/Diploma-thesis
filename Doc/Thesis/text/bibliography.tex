...
\bibitem{onlineDomainDrivenDesign}
	\emph{http://www.domaindrivendesign.org/}
	
\bibitem{onlineDocumentDBRanking}
	\emph{http://db-engines.com/en/ranking/document+store}
	
\bibitem{onlineMongoDB}
	\emph{www.mongodb.org}
	
\bibitem{onlineCouchDB}
	\emph{couchdb.apache.org}

\bibitem{onlineRavenDB}
	\emph{ravendb.net}
	
\bibitem{onlineRavenDBonLinux}
...
\bibitem{onlineJsonLdDesignGoals}
